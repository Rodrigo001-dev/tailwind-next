...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      complete: {
        container: 'bg-violet-500 dark:border-violet-300/30',
      },
      error: {
        container:
          'border-error-300 bg-error-25 dark:border-error-500/30 dark:bg-error-500/5',
        icon: 'border-error-50 bg-error-100 text-error-600 dark:border-error-50/30 dark:bg-error-500/5 dark:text-error-400',
        deleteButton:
