...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 shadow-sm hover:border-violet-25 hover:text-violet-500"
    >
